...
export const ItemsLeagues = ({ path, name, link }) => {
  return (
    <Link to={link} target='_blank' className='relative md:w-[480px] h-full bg-blue-300 inline-block mr-8 ml-2 rounded-md hover:scale-105 transition-all'>
