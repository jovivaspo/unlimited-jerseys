  ...
  return (
    <div id="pedido" className="w-full">
       ...
       <section className="my-8 p-5  mx-auto lg:mt-32 xl:w-[1280px]">
           <h3 className="my-4 text-3xl font-bold text-yellow "> ¿Quieres realizar un pedido? Te explicamos cómo hacerlo.</h3>
        <ol>
          ...
          <ul className="list-disc ml-8">
            <li>Formulario de contacto: Completa nuestro <a className="text-yellow" href="#formulario">formulario de contacto</a> con los detalles de los productos seleccionados y las tallas correspondientes.</li>
            <li>Whatsapp: Envíanos un mensaje por  <a className="text-yellow"
                  aria-label="Chat on WhatsApp"
                  target="_blank"
                  href="https://wa.me/722452544" rel="noreferrer">
                      Whatsapp
                  </a> con los productos elegidos y las tallas que necesitas.</li>
            <li> Mensaje directo en Instagram: Si lo prefieres, también puedes contactarnos por mensaje directo en <a className="text-yellow" target="_blank" href="https://www.instagram.com/unlimitedjerseys123/" rel="noreferrer">Instagram</a> para realizar tu pedido.</li>
          </ul>
          </li>
          <li>
